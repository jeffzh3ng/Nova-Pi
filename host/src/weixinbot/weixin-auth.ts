 ...
 *
 * Nova 改造点：stateDir 不再写死 ~/.pi/agent/weixin，由 host 通过 setStateDir 注入。
 */
...
export function getStateDir(): string {
  return configuredStateDir ?? path.join(homedir(), ".pi", "agent", "weixin");
}
