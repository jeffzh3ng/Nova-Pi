...
const BUILT_IN_SERVICE_META: Record<string, McpServiceMeta> = {
  [NETWORK_RISK_ASSESSMENT_MCP_SERVICE]: {
    title: "网安风评数字员工 MCP",
    description: "网络安全风险评估数字员工使用的 MCP 服务连接。",
    enabledDescription: "连接成功后网安风评数字员工显示为可用",
    pathPlaceholder: "D:\\path\\to\\network-risk-assessment-mcp\\server.py",
  ...
  [GO_LIVE_SECURITY_ASSESSMENT_MCP_SERVICE]: {
    title: "上线安评数字员工 MCP",
    description: "新系统上线安全评估数字员工使用的 MCP 服务连接。",
    enabledDescription: "连接成功后上线安评数字员工显示为可用",
    pathPlaceholder: "D:\\path\\to\\go-live-security-assessment-mcp\\server.py",
    httpPlaceholder: "http://127.0.0.1:8765/mcp",
  },
  [DUAL_NEW_ASSESSMENT_MCP_SERVICE]: {
    title: "双新安评数字员工 MCP",
    description: "新技术新业务评估数字员工使用的 MCP 服务连接。",
    enabledDescription: "连接成功后双新安评数字员工显示为可用",
    pathPlaceholder: "D:\\path\\to\\dual-new-assessment-mcp\\server.py",
    httpPlaceholder: "http://127.0.0.1:8765/mcp",
  },
  [INCIDENT_RESPONSE_MCP_SERVICE]: {
    title: "应急响应数字员工 MCP",
    description: "安全事件应急响应数字员工使用的 MCP 服务连接。",
    enabledDescription: "连接成功后应急响应数字员工显示为可用",
    pathPlaceholder: "D:\\path\\to\\incident-response-mcp\\server.py",
    httpPlaceholder: "http://127.0.0.1:8765/mcp",
  },
  [INCIDENT_DRILL_MCP_SERVICE]: {
    title: "应急演练数字员工 MCP",
    description: "安全应急演练数字员工使用的 MCP 服务连接。",
    enabledDescription: "连接成功后应急演练数字员工显示为可用",
    pathPlaceholder: "D:\\path\\to\\incident-drill-mcp\\server.py",
    httpPlaceholder: "http://127.0.0.1:8765/mcp",
  },
  [SECURITY_TRAINING_MCP_SERVICE]: {
    title: "安全培训数字员工 MCP",
    description: "安全培训数字员工使用的 MCP 服务连接。",
    enabledDescription: "连接成功后安全培训数字员工显示为可用",
    pathPlaceholder: "D:\\path\\to\\security-training-mcp\\server.py",
    httpPlaceholder: "http://127.0.0.1:8765/mcp",
  },
  [SECURITY_BULLETIN_MCP_SERVICE]: {
    title: "安全通告数字员工 MCP",
    description: "安全通告数字员工使用的 MCP 服务连接。",
    enabledDescription: "连接成功后安全通告数字员工显示为可用",
    pathPlaceholder: "D:\\path\\to\\security-bulletin-mcp\\server.py",
    httpPlaceholder: "http://127.0.0.1:8765/mcp",
  },
  [ALERT_ANALYSIS_MCP_SERVICE]: {
    title: "威胁研判数字员工 MCP",
